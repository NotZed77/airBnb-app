...
public class BookingServiceImpl implements BookingService {
    ...
    public BookingDto initialiseBooking(BookingRequest bookingRequest) {
        ...
        // Reserves the room and update the booked count of inventories
    ...
    public BookingDto addGuests(Long bookingId, List<GuestDto> guestDtoList) {
        ...
        log.info("Current user id: {}, Booking user id: {}", user.getId(), booking.getUser().getId());
    ...
    @Override
    public String getBookingStauts(Long bookingId) {
        Booking booking = bookingRepository.findById(bookingId).orElseThrow(
                () -> new ResourceNotFoundException("Booking not found with id: "+bookingId)
        );
        User user = getCurrentUser();
    ...
    @Override
    public HotelRecordDto getHotelReport(Long hotelId, LocalDate startDate, LocalDate endDate) {
        Hotel hotel = hotelRepository.findById(hotelId)
                .orElseThrow(() -> new ResourceNotFoundException("Hotel not found with ID: "+hotelId));
        ...
        return new HotelRecordDto(totalConfirmedBookings, totalRevenueOfConfirmedBookings, avgRevenue);
    }
